...
class TaskServiceTest {
    ...
    void shouldThrowWhenTaskNotFoundOnUpdate() {
        ...
        TaskDto updateDto = new TaskDto(99L, "Updated", false);

        assertThrows(RuntimeException.class, () -> service.updateTask(99L, updateDto));
    }

    @Test
    void shouldAddTask() {
        TaskDto dto = new TaskDto(null, "New Task", false);
